...
window.PirabelI18n = (function() {
  ...
  const translations = {
    fr: {
      ...
      'btn.apply': '⚡ Appliquer',
      'btn.undo': '↶ Annuler',
      'btn.compare': '👁️ Avant/Après',
      'btn.download': '⬇ Télécharger',
      'btn.reuse': '🔄 Réutiliser',
      'btn.quickExport': '⚡ Export rapide',
      'btn.autoIA': '🤖 Auto-IA',

      // Edit panel
      'edit.title': '🎨 Édition avancée',
      'edit.show': 'Afficher',
      'edit.hide': 'Masquer',
      'edit.filters': '🎭 Filtres',
      'edit.crop': '✂️ Recadrer',
      'edit.resize': '📐 Resize',
      'edit.watermark': '🏷️ Watermark',
      'edit.stickers': '🖼️ Stickers',
      'edit.annotate': '✏️ Annoter',
      'edit.adjust': '🌈 Réglages',
      'edit.presets': '📋 Presets',

      // Filters
      'filter.apply': 'Appliquer le filtre',
      'filter.desc': 'Applique un filtre artistique à ton image :',
      ...
      'resize.custom': 'Ou taille personnalisée',
      ...
      // Stickers
      'sticker.desc': 'Clique sur un emoji puis clique sur l\'image pour le placer :',
      'sticker.size': 'Taille',
      ...
      'annotate.size': 'Épaisseur',
      'annotate.tool.pen': '✏️ Stylo',
      ...
      // Adjustments
      'adjust.desc': 'Règle manuellement l\'apparence de ton image :',
      'adjust.brightness': 'Luminosité',
      'adjust.contrast': 'Contraste',
      'adjust.saturation': 'Saturation',
      'adjust.apply': 'Appliquer les réglages',
      'adjust.reset': 'Réinitialiser',

      // Presets
      'preset.desc': 'Sauvegarde et réutilise tes configurations préférées :',
      'preset.save': '💾 Sauvegarder config actuelle',
      'preset.name': 'Nom du preset',
      'preset.empty': 'Aucun preset sauvegardé',
      'preset.load': 'Charger',
      'preset.delete': 'Supprimer',

      // Batch
      'batch.info': 'Mode lot — disponible avec Pass 3 jours ou Mensuel.',
      'batch.select': 'Sélectionner plusieurs images',
      'batch.hint': 'Toutes seront traitées en une fois',
      'batch.process': '⚡ Traiter toutes',
      'batch.downloadAll': '⬇ Tout télécharger',
      'batch.clear': '✕ Vider',

      // Gallery
      'gallery.info': 'Tes 12 dernières images traitées (stockage local).',
      'gallery.empty': 'Aucune image traitée',
      'gallery.clear': '🗑️ Vider la galerie',
      ...
      'quota.chooseplan': 'Tu as utilisé toutes tes images. Choisis un plan pour continuer :',

      // Quick export
      'quickexport.title': '⚡ Export rapide',
      'quickexport.desc': 'Télécharge en 1 clic dans tous les formats :',
      'quickexport.all': '📦 Tout télécharger (PNG + JPG + WEBP)',
      ...
      // Newsletter
      'newsletter.title': '📬 Reste informé',
      'newsletter.desc': 'Reçois les nouveautés, promos et astuces par email.',
      ...
      // Toasts
      'toast.imagePasted': 'Image collée',
      'toast.selectionCleared': 'Sélection effacée',
      'toast.applied': '✓ Suppression appliquée',
      'toast.undone': 'Annulé',
      'toast.nothingToUndo': 'Rien à annuler',
      'toast.downloaded': '✓ Téléchargé',
      'toast.quotaExhausted': '❌ Quota épuisé',
      'toast.filterApplied': '✓ Filtre appliqué',
      'toast.cropApplied': '✓ Recadré',
      'toast.resized': '✓ Redimensionné',
      'toast.watermarkApplied': '✓ Watermark ajouté',
      'toast.stickerPlaced': '✓ Sticker placé',
      'toast.annotationsApplied': '✓ Annotations appliquées',
      'toast.adjustApplied': '✓ Réglages appliqués',
      'toast.presetSaved': '✓ Preset sauvegardé',
      'toast.presetLoaded': '✓ Preset chargé',
      'toast.presetDeleted': 'Preset supprimé',
      'toast.loadImage': 'Charge d\'abord une image',
      'toast.selectZone': 'Sélectionne d\'abord une zone',
      'toast.batchPro': '🔒 Mode lot réservé aux plans Pro',
      'toast.galleryClear': 'Galerie vidée',
      'toast.exportStarted': 'Export en cours...',
      'toast.allExported': '✓ Tous les formats exportés',
    ...
    en: {
      ...
      // Stickers
      'sticker.desc': 'Click an emoji then click on the image to place it:',
      'sticker.size': 'Size',
